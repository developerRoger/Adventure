...
import com.firstTry.Adventure.entity.ColumnEntity;
import com.firstTry.Adventure.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
		...
		for (Map<String, String> column : columns) {
			...
			columnEntity.setAttrname((new StringBuilder()).append(Character.toLowerCase(attrName.charAt(0)))
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.firstTry" : mainPath;
		// 封装模板数据
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("Entity.java.vm")) {
			return "main" + File.separator + "resources" + File.separator + "entity" + File.separator + className
					+ "Entity.java";
		}
		...
		if (template.contains("Service.java.vm")) {
			return "main" + File.separator + "resources" + File.separator + "service" + File.separator + className
					+ "Service.java";
		}

		if (template.contains("ServiceImpl.java.vm")) {
			return "main" + File.separator + "resources" + File.separator + "service" + File.separator + "impl"
					+ File.separator + className + "ServiceImpl.java";
		}

		if (template.contains("Controller.java.vm")) {
			return "main" + File.separator + "resources" + File.separator + "controller" + File.separator + className
					+ "Controller.java";
		}
